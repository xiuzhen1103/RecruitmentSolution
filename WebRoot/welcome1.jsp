...
<div class="info"">
	...
	<div class="row clearfix">
		...
		<s:iterator value="listMainSkillCategorys" id="s">
 		<td  align="center" > <a href="job!first1.action?skillCategory.skillCategoryId=<s:property value='#s.skillCategoryId' />"> <s:property value="#s.name" /> </a></td>
 		</s:iterator>
		...
		<s:iterator value="listCountrys" id="c">
 		<td  align="center" > <a href="job!first1.action?area.areaId=<s:property value='#c.areaId' />"> <s:property value="#c.areaName" /> </a></td>
 		</s:iterator>
		</div>
