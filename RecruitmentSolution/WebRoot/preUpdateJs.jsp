...
<html>
  ...
  <body>
  <b> Update JobSeeker </b>
 		<form method="post" action="updateJs">
  	    JobSeeker Id:<input type="text" name="js.jsId" value="<s:property value='js.jsId'/>" readonly><br>
  	    Username:<input type="text" name="js.username" value="<s:property value='js.username'/>" readonly><br>
    	...
    	Email:<input type="text" name="js.email" value="<s:property value='js.email'/>" readonly><br>
