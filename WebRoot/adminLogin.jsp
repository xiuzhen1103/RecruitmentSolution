...
<div class="login-panel">
		...
		<input type="text" name="admin.username" tabindex="1" value="" id="email" class="input-text">
		</p><p class="clearfix">
		<label for="password">Password:</label>
		<input type="password" id="password" name="admin.password" class="input-text" tabindex="2" />
</p>
<p class="right">
